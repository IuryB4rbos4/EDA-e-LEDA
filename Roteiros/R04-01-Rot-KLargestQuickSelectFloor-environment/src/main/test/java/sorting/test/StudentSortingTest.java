...
public class StudentSortingTest {
	...
	public void setUp() {
		...
		valoresNegativos(new Integer[] { 1, 2, 3, 4, 5, 7}, 6);


		valoresNegativos2(new Integer[] { -9, -6, -5, -2, -1, 0});

		valoresNegativos3(new Integer[] { -9, -6, -5, -2, -1, 0});

		valoresNegativos4(new Integer[] { -9, -6, -5, -2, -1, 0});
	...
	public void genericTest(Integer[] array, Integer x) {
		Integer[] copy1 = {};
		if(array.length > 0){
